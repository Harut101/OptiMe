export const enUS = {
  ...
  common: {
    save: 'Save', cancel: 'Cancel', back: 'Back', edit: 'Edit', delete: 'Delete', add: 'Add', continue: 'Continue', retry: 'Try again', loading: 'Loading...', saving: 'Saving...', discard: 'Discard', keepEditing: 'Keep editing', saved: 'Saved', notSet: 'Not set', noneAdded: 'None added', close: 'Close', at: 'at', minutesShort: 'min'
  },
  ...
  auth: {
    welcomeTitle: 'Welcome to OptiMe.', welcomeMessage: 'Nutrition that adapts to your day, with training when you want it and health-aware planning when available.', dailyPlanning: 'Daily planning', dailyPlanningMessage: 'Set up your profile and generate a simple plan for food, training, hydration, and recovery.', valueNutrition: 'Nutrition that adapts to your day', valueTraining: 'Training when you want it', valueHealth: 'Health data-aware planning', trustNote: 'Supportive guidance. No shame, no extreme advice.', signInSecurely: 'Sign in securely', createSecurely: 'Create your account securely', checkDetails: 'Check your details and try again.', createAccount: 'Create account', login: 'Log in', welcomeBack: 'Welcome back', loginMessage: 'Log in to continue your daily plan flow.', loggingIn: 'Logging in...', loginFailed: 'Could not sign in', email: 'Email', password: 'Password', createTitle: 'Create your account', createMessage: 'We use your setup details to create practical, supportive daily guidance.', creatingAccount: 'Creating account...', createFailed: 'Could not create account', existingAccount: 'I already have an account', consent: 'I agree that OptiMe may use my profile and preferences to generate wellness plans.', consentRequired: 'Please confirm before creating your account.', preparing: 'Getting things ready', checkingSession: 'Checking your session.', loadingSetup: 'Loading your setup', preparingNextStep: 'We are preparing your next step.', verifyEmail: 'Verify email', verifyEmailMessage: 'Enter the six-digit code sent to your email. It expires in 10 minutes.', verificationCode: 'Verification code', verifyAndContinue: 'Verify and continue', verifying: 'Verifying...', resendCode: 'Send a new code', resendingCode: 'Sending...', codeSent: 'A new code was sent.', codeSendFailed: 'Could not send the code. Please try again.', invalidCode: 'Enter the six-digit code.', invalidOrExpiredCode: 'The code is invalid or has expired.', forgotPassword: 'Forgot password?', forgotPasswordMessage: 'Enter your email and we will send a password reset code if an account exists.', sendResetCode: 'Send reset code', sendingCode: 'Sending code...', resetPassword: 'Reset password', resetPasswordMessage: 'Enter the code from your email and choose a new password.', newPassword: 'New password', confirmPassword: 'Confirm password', passwordsDoNotMatch: 'Passwords do not match.', resettingPassword: 'Resetting password...'
  },
  legal: {
    privacyPolicy: 'Privacy Policy',
    termsOfService: 'Terms of Service',
    unavailableTitle: 'Legal information unavailable',
    unavailableMessage: 'Public Privacy Policy and Terms of Service links are not configured for this build.',
    privacyPolicyHelp: 'How OptiMe collects, uses, stores, and deletes data.',
    termsOfServiceHelp: 'Rules for using OptiMe and its wellness guidance.',
    accountDataControls: 'Account data controls',
    accountDataControlsHelp: 'Manage health data or permanently delete your account.'
  },
  onboarding: {
    foundationTitle: 'Your profile', foundationMessage: 'A few basics help keep your first plan safe, realistic, and age-aware.', stepProfile: 'Profile basics', stepGoal: 'Your goal', stepFood: 'Nutrition preferences', progress: 'Step {{current}} of {{total}}', progressProfile: 'Step 1 of 3', progressGoal: 'Step 2 of 3', progressFood: 'Step 3 of 3', progressComplete: 'Onboarding complete', safetyNote: 'Safety note', profileNotSaved: 'Profile was not saved', checkProfile: 'Check your profile', languageTitle: 'Plan language', languagePlanHelp: 'New AI plans and recommendations will be generated in this language. You can change it later; plans already created stay in their original language.', directionTitle: 'Choose your goal', directionMessage: 'Pick the outcome and app mode that best match this season.', goalHealthyEatingHelp: 'Balanced meals and steady energy without strict rules.', goalMaintenanceHelp: 'Support consistency, strength, and energy while staying steady.', goalWeightGainHelp: 'Support muscle and strength with practical nutrition.', goalWeightLossHelp: 'Use safe, gradual guidance without pressure language.', appModeNutritionOnlyHelp: 'Food planning, meal tracking, and health-aware targets.', appModeTrainingHelp: 'Food planning, workout guidance, and training load support.', changeLater: 'You can change this later from Profile.', safeGoalTitle: "Let's keep this goal safe", checkGoal: 'Check your goal', foodTitle: 'Nutrition preferences', foodMessage: 'Confirm allergies now. Preferences can be refined later from Food.', preferencesNotSaved: 'Preferences were not saved', allergyNeededTitle: 'Allergy information needed', allergyNeededMessage: 'Add any food allergies or confirm that you have no known food allergies so we can keep your plan safer.', personalizeTraining: 'Personalize training', personalizeTrainingMessage: 'Optional. You can finish onboarding without this and update it later from Training.', trainingNotSaved: 'Training preferences were not saved', notNow: 'Not now', continueToday: 'Continue to Today', trainingEnabledTitle: 'Set up your Weekly Routine?', trainingEnabledMessage: 'You can start with nutrition today and configure training whenever it fits.', trainingOptionalTitle: 'Training is optional', trainingOptionalMessage: 'Set day-specific muscle focus, equipment, and duration when you are ready.', setUpWeeklyRoutine: 'Set up now', skipTrainingSetup: 'Skip for now', setUpTrainingLater: 'Set up training later', configureTrainingAnytime: 'You can configure training anytime from the Training tab.', activityLevel: 'Activity level'
  },
  today: {
    title: 'Today', tagline: 'Steady, practical, ready.', intro: 'A simple plan for food, training, hydration, and recovery today.', loading: 'Loading Today', loadingMessage: 'Checking whether a plan already exists.', unavailable: 'Today is unavailable', noPlan: 'No plan yet', noPlanMessage: 'Generate a simple plan for food, training, hydration, and recovery today.', generate: 'Generate today plan', generating: 'Generating...', refresh: 'Refresh plan', refreshing: 'Refreshing...', generated: 'Plan generated.', refreshed: 'Plan refreshed', updateFailed: 'Plan update failed', details: 'View plan details', updatedAt: 'Updated {{time}}', safetyNote: 'Safety note', nutrition: 'Nutrition', training: 'Training', trainingOffTitle: 'Training is off', trainingOffMessage: 'You can enable it whenever it fits your goals.', enableTraining: 'Enable training', recovery: 'Recovery', protein: 'Protein', carbs: 'Carbs', fat: 'Fat', limitReached: 'Limit reached', upgradeSoon: 'Upgrade options coming soon.', planUsage: 'Plan usage', usageUnavailable: 'Plan details unavailable', generationsLeft: 'Generations left today: {{count}}', refreshesLeft: 'Refreshes left today: {{count}}', setupNeeded: 'A little setup is needed', setupNeededMessage: 'Please finish the required basics so we can keep your first plan safe.', continueSetup: 'Continue setup', trainingTodayPromptTitle: 'Are you training today?', trainingTodayPromptMessage: 'Today is currently set as a rest day in your Weekly Routine. Rest is useful too, so choose what fits today.', trainingPlannedPromptMessage: 'A workout is planned for today. Would you like a training plan or a rest-day plan?', generateTrainingPlan: 'Generate training plan', generateRestDayPlan: 'No, generate rest-day plan', setUpTodaysWorkout: 'Yes, train today only', trainingRoutineUpdated: 'Weekly Routine updated', trainingRoutineUpdatedReady: 'Routine saved. Generating your plan now.', trainingRoutineUpdatedExistingPlan: 'Your routine was saved. You already have a plan for today, so refresh only if you want to replace it.', improvePlans: 'Improve future plans', yourAnswer: 'Your answer', listPlaceholder: 'Separate items with commas', chooseOne: 'Choose one', chooseAny: 'Choose any that fit', answer: 'Answer', skip: 'Skip for now', quickDetail: 'One quick detail', numberNeeded: 'Please enter a number, or skip this for now.', optionNeeded: 'Choose an option, or skip this for now.', optionsNeeded: 'Choose at least one option, or skip this for now.', answerNeeded: 'Add an answer, or skip this for now.', answerSaveFailed: 'Could not save this answer', promptSkipFailed: 'Could not skip this prompt', keepUsingToday: 'You can keep using Today.', limitMessage: "You've reached today's limit for this plan. Your {{plan}} plan includes {{limit}} {{action}} per day. {{reset}}", tryAfter: 'Try again after {{time}}.', tryAfterReset: 'Try again after reset.', usageGeneration: 'plan generation', usageRefresh: 'refresh', usageAiGeneration: 'AI plan generation'
  },
  eveningReflection: {
    open: 'Reflect on today',
    title: 'How did today feel?',
    subtitle: 'Optional and private to your plan.',
    help: 'A quick reflection helps future plans stay practical and recovery-aware.',
    energy: 'Energy',
    tiredness: 'Tiredness',
    soreness: 'Soreness',
    level3: 'Low',
  ...
  weight: {
    ...
    updatedMessage: 'Weight updated. Future plans will use this value.',
  ...
  profile: {
    title: 'Profile', hubIntro: 'Manage your account, goals, settings, and safety context in one calm place.', sections: { personal: 'Personal', health: 'Health', connections: 'Connections', settings: 'Settings' }, firstName: 'First name', lastName: 'Last name', dateOfBirth: 'Date of birth', datePlaceholder: 'YYYY-MM-DD', height: 'Height ({{unit}})', weight: 'Weight ({{unit}})', gender: 'Gender', activity: 'Activity level', healthContext: 'Optional health context', pregnancyContext: 'Pregnancy / postpartum context', pregnancyHelp: 'Optional. Used only to keep nutrition and training guidance safer.', chooseToday: 'Choose what fits today', preparing: 'Preparing your profile.', unavailable: 'Profile unavailable', savedMessage: 'Personal details saved. Future recommendations will use your updates.', saveFailed: 'Profile was not saved', account: 'Account', editProfile: 'Edit personal details', personal: 'Personal', nameMissing: 'Name not added', bornSummary: 'Born {{date}} · {{height}} · {{weight}}', activitySummary: 'Activity: {{value}}', healthGoalSection: 'Goal and nutrition', healthGoalHelp: 'Goal, food, and weight changes affect future plans.', currentGoal: 'Current goal', goalsAndMode: 'Goals and mode', goalModeValue: '{{goal}} · {{mode}}', nutritionPreferencesSummary: 'Food preferences and meal planning live in Food.', trainingHubHelp: 'Routine, workouts, and history live in Training.', weightHubHelp: 'Your current weight helps future nutrition targets. Past plans stay unchanged.', modeSummary: 'App mode: {{mode}}', trainingOptional: 'Training is optional. Nutrition planning still works when training is off.', noGoal: 'No goal saved', goalHelp: 'Goal updates remain owned by the goal resource, not the profile payload.', editGoals: 'Edit goals', addGoals: 'Add goals', wellnessSafety: 'Wellness safety', safeMode: 'Safe mode is active.', standardMode: 'Standard wellness mode is active.', ageSafety: 'Age-aware safety is derived by the backend from your date of birth.', healthContextTitle: 'Health context', healthContextCopy: 'Pregnancy and postpartum context can be updated under Personal when relevant.', important: 'Important'
  },
  goals: {
  ...
  settings: {
    title: 'Settings', account: 'Account', accountHelp: 'Plan, language, units, and privacy controls.', signedIn: 'Signed in', subscription: 'Subscription', application: 'Application settings', language: 'Language', languageHelp: 'Choose the language used by the application shell.', languagePlanHelp: 'New AI plans use this language. Plans already created keep their original language.', languagePlanNotice: 'Language updated. New AI plans will use this language; plans already created keep their original language.', languagePlanRecreateTitle: 'Recreate today’s plan?', languagePlanRecreateMessage: 'Your current plan uses the previous language. You can keep it as it is or recreate it in the language you just selected.', languagePlanRecreateAction: 'Recreate plan', languagePlanKeepCurrentAction: 'Keep current plan', languagePlanRecreated: 'Today’s plan was recreated in your selected language.', languagePlanRecreateFailed: 'We could not recreate today’s plan. Your current plan is still available.', measurementSystem: 'Measurement system', measurementHelp: 'Choose how measurements are displayed. Stored values remain unchanged.', metric: 'Metric', imperial: 'Imperial', theme: 'Appearance', themeHelp: 'Choose whether OptiMe follows your device or always uses a light or dark appearance.', themeSystem: 'System', themeLight: 'Light', themeDark: 'Dark', save: 'Save settings', saved: 'Settings updated.', loadError: 'Settings are unavailable right now.', saveError: 'Settings could not be saved.', saveErrorHelp: 'Your previous settings are still active. Please try again when the connection is steady.', planUnavailable: 'Plan details unavailable', usageUnavailable: 'Usage details unavailable', usageToday: 'Usage limits are shown on Today when available.', upgradeSoon: 'Upgrade options coming soon.', futureControls: 'Notification controls are planned. No unsaved setting is presented as active.', support: 'Support and privacy', privacyAccount: 'Privacy and account', privacyCopy: 'Manage connected health data or permanently delete your OptiMe account.', accountControlHelp: 'Account deletion removes your profile, plans, history, and imported health data.', deleteAccount: 'Delete account', deleteAccountHelp: 'Enter your current password to permanently delete this account and its OptiMe data.', currentPassword: 'Current password', deleteAccountConfirmTitle: 'Permanently delete your account?', deleteAccountConfirmMessage: 'This cannot be undone. Your profile, plans, tracking history, and imported health data will be removed.', deleteAccountConfirmAction: 'Delete permanently', deletingAccount: 'Deleting account...', deleteAccountFailed: 'Account was not deleted', deleteAccountFailedHelp: 'Check your current password and connection, then try again.', logout: 'Log out', logoutHelp: 'Sign out on this device.'
  },
  progressive: {
  ...
  safety: { disclaimer: 'OptiMe is an AI wellness assistant, not a medical service. It does not diagnose or treat medical conditions. For injuries, pregnancy/postpartum concerns, medical symptoms, or major lifestyle changes, consider consulting a qualified professional.', goalSteady: "Let's choose a steadier goal that supports energy, training, and recovery.", goalHealthContext: 'For this health context, OptiMe keeps goals focused on steady energy, recovery, hydration, and balanced habits.', goalProfile: 'Please finish your profile first so we can keep this goal safe and realistic.', goalGeneric: 'Please adjust this goal and try again. We want the plan to stay safe, steady, and practical.', planAdjustedBalanced: 'Today was adjusted toward balanced meals, hydration, recovery, and healthy movement.', planAdjustedSteady: 'Today was adjusted toward a steadier plan that supports energy, training, and recovery.', planAdjustedHealthContext: 'Today uses gentler, balanced guidance based on your health context.', planAdjustedFoodSafety: 'A safer plan was used to respect your allergies and excluded foods.', planAdjustedTraining: 'Training intensity was reduced to keep movement conservative and recovery-friendly.', planAdjustedReview: 'A more conservative plan was used after the safety review.', planAdjustedFallback: 'A reliable safe plan was used because the generated plan could not be fully verified.', planAdjustedGeneric: 'Today was adjusted toward a safer, steadier plan.' },
...
Object.assign(enUS.auth, {
  consent: 'I agree to the Privacy Policy and Terms of Service and consent to OptiMe processing my profile and preferences to provide wellness plans.'
});
