...
assertIncludes(tabs, ['tabBarShowLabel: false', 'tabBarActiveTintColor: colors.textPrimary', 'sceneStyle: { backgroundColor: colors.background, paddingBottom: 68 }', 'bottom: Math.max(insets.bottom - 8, 8)', 'left: 16', 'right: 16', "width: 'auto'", 'borderWidth: 1', "position: 'absolute'", 'translateY: -2', 'focused ? 28 : 24'], 'Floating tab navigation');
