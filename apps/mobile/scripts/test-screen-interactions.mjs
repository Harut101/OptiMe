...
assertIncludes(tabs, ['tabBarShowLabel: false', 'tabBarActiveTintColor: colors.textPrimary', 'sceneStyle: { backgroundColor: colors.background, paddingBottom: 72 }', 'bottom: Math.max(insets.bottom - 8, 8)', 'left: 16', 'right: 16', "width: 'auto'", 'borderWidth: 1', "position: 'absolute'", 'translateY: -2', 'focused ? 30 : 26'], 'Floating tab navigation');
