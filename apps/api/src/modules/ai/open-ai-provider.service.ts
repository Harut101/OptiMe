...
export class OpenAiProviderService implements AiProvider {
  ...
  private buildSystemInstructions(input: GenerateDailyPlanInput, retry: boolean) {
    return [
      ...
      'If wearableContext is present, treat it as optional wellness context only; it may be stale or incomplete.',
      ...
      'If wearableContext.isStale is true or hasRecentData is false, do not personalize strongly from it.',
