...
export const foodNutritionTotalsSchema = z.object({
...
export const foodIngredientSchema = foodNutritionTotalsSchema.extend({
...
export const foodMealSchema = foodNutritionTotalsSchema.extend({
